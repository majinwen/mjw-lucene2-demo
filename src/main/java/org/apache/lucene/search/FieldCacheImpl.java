 ...
 * @since   lucene 1.4
 * @version $Id: FieldCacheImpl.java,v 1.2 2014/01/10 10:00:03 lhelper Exp $
 */
...
implements FieldCache {
  ...
  abstract static class Cache {
    public final Map readerCache = new WeakHashMap();
  ...
  public byte[] getBytes(IndexReader reader, String field, ByteParser parser)
      throws IOException {
    return (byte[]) bytesCache.get(reader, new Entry(field, parser == null ? BYTE_PARSER : parser));
  }
  ...
  public short[] getShorts(IndexReader reader, String field, ShortParser parser)
      throws IOException {
    return (short[]) shortsCache.get(reader, new Entry(field, parser == null ? SHORT_PARSER : parser));
  }
  ...
  public int[] getInts(IndexReader reader, String field, IntParser parser)
      throws IOException {
    return (int[]) intsCache.get(reader, new Entry(field, parser == null ? INT_PARSER : parser));
  }
  ...
  public float[] getFloats(IndexReader reader, String field, FloatParser parser)
      throws IOException {
    return (float[]) floatsCache.get(reader, new Entry(field, parser == null ? FLOAT_PARSER : parser));
  }
  ...
  public void purge(IndexReader reader) {
    bytesCache.purge(reader);
    shortsCache.purge(reader);
    intsCache.purge(reader);
    floatsCache.purge(reader);
    stringsCache.purge(reader);
    stringsIndexCache.purge(reader);
    autoCache.purge(reader);
    customCache.purge(reader);
  }
}
