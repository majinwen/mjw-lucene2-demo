 ...
 * @since   lucene 1.4
 * @version $Id: FieldCache.java,v 1.2 2013/12/11 20:36:52 lhelper Exp $
 */
public interface FieldCache {
   ...
   * @see FieldCache#getBytes(IndexReader, String, ByteParser)
   */
   ...
   * @see FieldCache#getShorts(IndexReader, String, ShortParser)
   */
   ...
   * @see FieldCache#getInts(IndexReader, String, IntParser)
   */
   ...
   * @see FieldCache#getFloats(IndexReader, String, FloatParser)
   */
   ...
   * NOTE: this reader must precisely match the
   * reader that the cache entry is keyed on. If you pass a
   * top-level reader, it usually will have no effect as
   * Lucene(2.9, 3.x, 4.x) caches at the segment reader level.
   */
  public abstract void purge(IndexReader reader);
}
